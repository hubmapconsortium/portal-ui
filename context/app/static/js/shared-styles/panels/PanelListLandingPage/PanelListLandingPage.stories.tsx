...
export function PanelListLandingPage(args: any) {
  return (
    <PanelListLandingPageComponent {...args}>
      <PanelListStory {...(PanelListStory as any).args} />
    </PanelListLandingPageComponent>
  );
}

(PanelListLandingPage as any).args = {
  title: 'Landing Page Title',
  subtitle: 'Landing Page Subtitle',
  description: lorem,
  panelsProps: (PanelListStory as any).args.panelsProps,
};
