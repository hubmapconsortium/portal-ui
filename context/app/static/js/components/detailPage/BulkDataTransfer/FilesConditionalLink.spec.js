...
test('the element is a link when dua has been agreed to', () => {
  render(<FilesConditionalLink hasAgreedToDUA="fake" openDUA={fakeOpenDUA} href="fakeref" fileName="file.txt" />);
...
test('the element is button when dua has not been agreed to', () => {
  render(<FilesConditionalLink hasAgreedToDUA={null} openDUA={fakeOpenDUA} href="fakeref" fileName="file.txt" />);
...
test('the button has on click works', async () => {
  ...
  render(<FilesConditionalLink hasAgreedToDUA={null} openDUA={mockOpenDUA} href="fakeref" fileName="file.txt" />);
