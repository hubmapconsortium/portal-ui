...
const datasetConfig = {
  ...
  fields: {
    table: [
      field('hubmap_id', 'HuBMAP ID'),
      field('dataset_type', 'Dataset Type'),
      field('raw_dataset_type', 'Raw Dataset Type'),
      field('assay_display_name', 'Assay Name'),
      field('analyte_class', 'Analyte Class'),
      field('processing', 'Processing'),
      field('processing_type', 'Processing Type'),
      field('pipeline', 'Pipeline'),
      field('visualization', 'Visualization'),
      field('assay_modality', 'Modality'),
    ],
