...
function App(props) {
  ...
  const { title, entity, vitessce_conf, endpoints, markdown, collection, errorCode, list_title } = flaskData;
  ...
  return (
    ...
    <Providers endpoints={endpoints} nexusToken={nexus_token}>
      <Header />
      <Routes flaskData={{ title, entity, vitessce_conf, markdown, collection, errorCode, list_title }} />
      <Footer />
    </Providers>
  );
}
