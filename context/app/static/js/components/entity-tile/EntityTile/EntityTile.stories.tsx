...
export const Donor = Template.bind({}) as any;
Donor.args = {
  uuid,
  entity_type: 'Donor',
  id: 'DNRID123',
...
export const Sample = Template.bind({}) as any;
Sample.args = {
  uuid,
  entity_type: 'Sample',
  id: 'SMPLID123',
...
export const Dataset = Template.bind({}) as any;
Dataset.args = datasetArgs;

export const InvertedColors = Template.bind({}) as any;
...
export const Overflow = Template.bind({}) as any;
Overflow.args = {
  ...datasetArgs,
  entityData: entityDataWithoutImage,
};

export const OverflowWithImage = Template.bind({}) as any;
...
export const ImageNotFound = Template.bind({}) as any;
