...
export const DATASETS_SEARCH_SLIDE: SlideConfig = {
  ...
  images: [
    {
      videoSrc: cdnUrl('datasets_search.webm'),
      src: '',
...
export const CLOUD_WORKSPACES_SLIDE: SlideConfig = {
  ...
  images: [
    {
      videoSrc: cdnUrl('workspaces.webm'),
      src: '',
...
export const BIOMARKERS_SLIDE: SlideConfig = {
  ...
  images: [
    {
      videoSrc: cdnUrl('biomarkers.webm'),
      src: '',
  ...
  views: [
    {
      ...
      carousel: [
        {
          src: cdnUrl('vitessce_codex.webp'),
        ...
        {
          src: cdnUrl('vitessce_slideseq.webp'),
        ...
        {
          src: cdnUrl('vitessce_rnaseq_snrnaseq.webp'),
        ...
        {
          src: cdnUrl('vitessce_3d_tissue_maps.webp'),
        ...
        {
          src: cdnUrl('vitessce_atacseq.webp'),
        ...
        {
          src: cdnUrl('vitessce_desi_lcms.webp'),
        ...
        {
          src: cdnUrl('vitessce_histology.webp'),
        ...
        {
          src: cdnUrl('vitessce_light_sheet.webp'),
        ...
        {
          src: cdnUrl('vitessce_maldi_ims.webp'),
        ...
        {
          src: cdnUrl('vitessce_seqfish.webp'),
        ...
        {
          src: cdnUrl('vitessce_visium.webp'),
    ...
    },
    {
      ...
      images: [
        {
          src: cdnUrl('scellop_kidney.webp'),
    ...
    },
    {
      ...
      images: [
        {
          src: cdnUrl('lineup_datasets.webp'),
    ...
    },
    {
      ...
      images: [
        {
          src: cdnUrl('integrated_maps.webp'),
