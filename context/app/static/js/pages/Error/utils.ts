...
export function getErrorTitleAndSubtitle(errorCode?: number, isMaintenancePage?: boolean, isErrorBoundary?: boolean) {
  ...
  const expectedTitle = errorCode !== undefined ? errorTitle[errorCode] : undefined;
