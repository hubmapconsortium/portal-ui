...
## [Autofluorescence Microscopy](assay/af.md)
...
## [Assay for Transposase-Accessible Chromatin (ATACseq)](assay/atacseq.md)
...
## [Co-detection by indexing (CODEX)](assay/codex.md)
...
## [Image Mass Cytometry (IMC)](assay/imc.md)
...
## [Liquid Chromatography Mass Spectrometry (LC-MS)](assay/lcms.md)
...
## [Matrix Assisted Laser Desorption/Ionization Imaging Mass Spectrometry (MALDI-IMS)](assay/maldi-ims.md)
...
## [Multiplexed Immunofluorescence (MxIF)](assay/mxif.md)
...
## [RNA Sequencing (RNAseq)](assay/rnaseq.md)
...
## [Sequencing by Fluorescence In-Situ Hybridization (seqFISH)](assay/seqfish.md)
...
## [Stained Microscopy](assay/pas.md)
...
## [Whole Genome Sequencing (WGS)](assay/wgs.md)
