  ...
  [
    {
      ...
      'coordinationSpace':
        {
          ...
          'embeddingZoom': { 'A': 3 },
          'embeddingTargetX': { 'A': 0 },
          'embeddingTargetY': { 'A': 0 },
          'spatialZoom': {},
          'spatialTargetX': {},
          'spatialTargetY': {},
        },
      'layout':
        [
          { 'component': 'obsSets', 'x': 4, 'y': 0, 'w': 4, 'h': 4, 'coordinationScopes': {} },
          { 'component': 'obsSetSizes', 'x': 8, 'y': 0, 'w': 4, 'h': 4, 'coordinationScopes': {} },
          {
            'component': 'scatterplot',
            'props': { 'mapping': 'UMAP', 'view': { 'target': [0, 0, 0], 'zoom': 3 } },
            'x': 0,
            'y': 0,
            'w': 4,
            'h': 4,
            'coordinationScopes':
              { 'embeddingType': 'UMAP', 'embeddingZoom': 'A', 'embeddingTargetX': 'A', 'embeddingTargetY': 'A' },
          },
          { 'component': 'heatmap', 'x': 0, 'y': 4, 'w': 12, 'h': 4, 'coordinationScopes': {} },
        ],
      'initStrategy': 'auto',
    },
    {
