...
Request body:
{
    ...
    "aggs": {
        ...
        "source_sample.mapped_specimen_type5": {
            "filter": {
                "term": {
                    "entity_type.keyword": "Dataset"
                }
    ...
    "sort": [
        {
            "mapped_last_modified_timestamp.keyword": "desc"
        }
    ],
    "highlight": {
        "fields": {
        ...
        "ancestor_ids14": {
            "ancestor_ids.keyword": {
                "buckets": [
                    ...
                    {
                        "doc_count": 51,
                        "key": "068aef7b9a77c6c61b85ad69cc8cf0d5"
                    },
                    {
                        "doc_count": 43,
                        "key": "eed96170f42554db84d97d1652bb23ef"
                    },
                    {
                        "doc_count": 40,
                        "key": "18d84f25098b6b1699a7575d16722c5c"
                    },
                    {
                        "doc_count": 40,
                        "key": "2a88141ee11dfe080c01db3620a35a39"
                    }
                ],
                "doc_count_error_upper_bound": 0,
                "sum_other_doc_count": 1959
            },
            "ancestor_ids.keyword_count": {
                "value": 577
            },
        ...
        "group_name12": {
            ...
            "group_name.keyword": {
                "buckets": [
                    ...
                    {
                        "doc_count": 29,
                        "key": "California Institute of Technology TMC"
                    }
                ],
                "doc_count_error_upper_bound": 0,
                "sum_other_doc_count": 0
        ...
        "source_sample.mapped_specimen_type5": {
            ...
            "source_sample.mapped_specimen_type.keyword": {
                "buckets": [
                    {
                        "doc_count": 134,
                        "key": "Fresh frozen tissue section"
                    },
                    {
                        "doc_count": 92,
                        "key": "FFPE slide"
                    ...
                    {
                        "doc_count": 92,
                        "key": "Flash frozen, liquid nitrogen"
                    },
                    {
                        "doc_count": 80,
                        "key": "Cryosections/curls from fresh frozen OCT"
                    },
                    {
                        "doc_count": 27,
                        "key": "PFA fixed frozen OCT block"
                    }
                ],
                "doc_count_error_upper_bound": 0,
        ...
        "hits": [
            {
                ...
                "_source": {
                    ...
                    "mapped_data_types": [
                        "PAS Stained Microscopy [Image Pyramid]"
                    ],
